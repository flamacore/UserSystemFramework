...
{
    public class BlockContactApiRequest : BaseApiRequest
    {
        private IUser _requestedContact;
        private IUser _requestingUser;
        public BlockContactApiRequest(IUser requestedContact, IUser requestingUser = null)
        {
        ...
        {
            ContactSystemController.Instance.ChangeContactRelationship(_requestedContact.ID, (int) ContactStatus.Blocked, _requestingUser.ID);
